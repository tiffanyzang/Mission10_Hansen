...
public partial class BowlingLeagueContext : DbContext
{
    ...
    public virtual DbSet<BowlerScore> Bowler_Scores { get; set; }

    public virtual DbSet<MatchGame> Match_Games { get; set; }

    public virtual DbSet<Team> Teams { get; set; }

    public virtual DbSet<Tournament> Tournaments { get; set; }

    public virtual DbSet<TourneyMatch> Tourney_Matches { get; set; }
